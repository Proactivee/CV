        ...
        ScrollView {
            VStack {
                ...
                VStack {
                    ...
                    Link("Retrouver mes projets sur GitHub",
                         destination: URL(string: "https://github.com/Proactivee?tab=repositories")!)
                        .italic()
                    ...
                    VStack {
                        ...
                        VStack(alignment: .leading) {
                            ...
                            Link("Lien Web", destination: URL(string:
                            "https://proactivee.github.io/OhMyFood/index.html")!)
                                .italic()
